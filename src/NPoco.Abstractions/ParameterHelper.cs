...
namespace NPoco
{
    public class ParameterHelper
    {
        ...
        /// <summary>
        /// Kept as a static entry point for backwards compatibility. The actual logic lives on
        /// <see cref="IDatabaseType.SetParameterValue"/> so each DatabaseType can override it
        /// (e.g. PostgreSQLDatabaseType adjusting NpgsqlDbType based on DateTime.Kind).
        /// </summary>
