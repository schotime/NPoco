...
namespace NPoco
{
    public partial class Database : IDatabase
    {
        ...
        private void OpenSharedConnectionImp(bool isInternal)
        {
            ...
            // _factory creates the connection and gives the ability for the factory to control this 
            // if it's not generated by the factory, we will pass in what we were constructed with. 
            if (string.IsNullOrEmpty(_sharedConnection.ConnectionString))
            {
                // We will set this to available connection string.
