...
namespace NPoco.Tests
{
    ...
    public class DatabaseTypeTests
    {
        ...
        public void AddOrderByIfNoneFound()
        {
            ...
            var pagedQuery = dbType.BuildPageQuery(0, 10, new SQLParts { sql = "select * from test where id = @0" }, ref args);
        ...
        public void AddPagingOnWithExistingOrderBy()
        {
            ...
            var args = new object[] { 1 };
            var pagedQuery = dbType.BuildPageQuery(0, 10, new SQLParts { sql = "select * from test where id = @0 order by 1" }, ref args);
        ...
        public void SupportNestedOrderBys()
        {
            ...
            var args = new object[] { 1 };
            var pagedQuery = dbType.BuildPageQuery(0, 10, new SQLParts
            {
